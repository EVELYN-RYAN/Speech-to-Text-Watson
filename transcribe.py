...
# Without the p1 and the p2 parameters, this method throws an incorrect number of argumnets error
...
def get_url():
   ...
   #wss://api.{location}.speech-to-text.watson.cloud.ibm.com/instances/{instance_id}/v1/recognize
    return (f"wss://api.{region}.speech-to-text.watson.cloud.ibm.com/instances/{instance_id}/v1/recognize")
